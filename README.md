...
- [ ] Explain what a token is used for.
  ...
  - a token is generated and used to easily authenticate

- [ ] What steps can you take in your web apps to keep your data secure?

  - using secure authentication as well as encrypting data

- [ ] Describe how web servers work.

  - web servers 'serve' data to the web page using HTTP
